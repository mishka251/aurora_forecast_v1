...
сам джанго располагается в папке /home/g/gimslaw8/aurora-forecast.ru/public_html/venv/lib/python2.7/site-packages

для начала надо переключиться на текущий virtualenv
заходим в папку с проектом

$ cd /home/g/gimslaw8/aurora-forecast.ru/public_html
$ source venv/bin/activate

проверяем правильно ли определился путь до pip:
$ which pip
/home/g/gimslaw8/aurora-forecast.ru/public_html/venv/bin/pip
...
$ pwd
/home/g/gimslaw8/aurora-forecast.ru/public_html/HelloDjango/HelloDjango/tmp
$ touch restart.txt
